...
namespace USTrails.API.Migrations
{
    ...
    [Migration("20240409140513_Update national scenic trail name and description data")]
    partial class Updatenationalscenictrailnameanddescriptiondata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("USTrails.API.Models.Domain.Trail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "The Pacific Crest National Scenic Trail is a long-distance hiking and equestrian trail closely aligned with the highest portion of the Cascade and Sierra Nevada mountain ranges. The trail's southern terminus is next to the Mexico–United States border, just south of Campo, California, and its northern terminus is on the Canada–US border.",
                        ...
                        new
                        {
                            ...
                            Description = "The Continental Divide National Scenic Trail is a trail between the U.S. border with Chihuahua, Mexico and the border with Alberta, Canada. It follows the Continental Divide of the Americas along the Rocky Mountains. Near the Canadian border the trail crosses Triple Divide Pass.",
                        ...
                        new
                        {
                            ...
                            Description = "The North Country National Scenic Trail is a long-distance hiking trail in the Midwestern and Northeastern United States. The trail extends from Lake Sakakawea State Park in North Dakota to the Appalachian Trail in Green Mountain National Forest in Vermont.",
                        ...
                        new
                        {
                            ...
                            Description = "The Ice Age National Scenic Trail is a trail that roughly follows the location of the terminal moraine from the last Ice Age. The western end of the trail is at Interstate State Park along the St. Croix River, and the eastern terminus lies at Potawatomi State Park near the city of Sturgeon Bay.",
                        ...
                        new
                        {
                            ...
                            Description = "The Florida National Scenic Trail runs from Big Cypress National Preserve to Fort Pickens at Gulf Islands National Seashore, Pensacola Beach. It provides permanent non-motorized recreation opportunity for hiking and other compatible activities and is within an hour of most Floridians.",
                            DifficultyId = (short)3,
                            LengthInMi = 1500.0,
                        ...
                        new
                        {
                            ...
                            Description = "The Pacific Northwest National Scenic Trail is a hiking trail running from the Continental Divide in Montana to the Pacific Ocean on Washington's Olympic Coast. Along the way, the it crosses three national parks, seven national forests, and two other national scenic trails.",
                            DifficultyId = (short)5,
                            LengthInMi = 1200.0,
